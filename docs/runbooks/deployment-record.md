...
| Cloudflare API egress | host and API container can reach rtc.live.cloudflare.com:443; if pinned, each connect IP was probed and SNI/Host stays rtc.live.cloudflare.com | Pending |
