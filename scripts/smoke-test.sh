...
usage() {
  echo "Usage: SMOKE_LIVEKIT_TOKEN=token SMOKE_MEETING_SLUG=slug SMOKE_PARTICIPANT_COOKIE='name=value' P2P_STUN_URLS=stun:host:3478 $0 https://meet.example.com wss://rtc.example.com" >&2
  exit 64
}
