...
const en = {
  ...
  'join.form': 'Join meeting',
  'join.submitting': 'Joining…',
  'join.loading': 'Checking meeting…',
  'join.lookupFailed': 'Meeting details could not be loaded. Check your connection and try again.',
  'join.retry': 'Retry',
  ...
  'controls.primaryToolbar': 'Primary meeting controls',
  'controls.more': 'More',
  'controls.audioDevices': 'Audio and devices',
  'controls.screenSettings': 'Screen sharing settings',
  'controls.webrtcData': 'WebRTC data',
  'controls.settings': 'Audio and sharing settings',
  'controls.settingsShort': 'Settings',
  'controls.navigation': 'Meeting navigation',
  ...
  'controls.callAudioVolume': 'Call audio volume',
  'controls.sharedAudioVolume': 'Shared audio volume',
  ...
  'controls.viewerTransport': 'Viewer screen transport',
  'controls.viewerTransportAuto': 'Auto (P2P first)',
  'controls.viewerTransportTurn': 'TURN relay',
  'controls.viewerTransportSfu': 'SFU relay',
...
const zhCN: Record<MessageKey, Message> = {
  ...
  'join.nickname': '昵称', 'join.password': '会议密码', 'join.ifRequired': '如会议要求', 'join.submit': '静音加入', 'join.form': '加入会议', 'join.submitting': '正在加入…', 'join.loading': '正在检查会议…', 'join.lookupFailed': '无法加载会议信息，请检查网络后重试。', 'join.retry': '重试',
  ...
  'controls.label': '会议控制', 'controls.primaryActions': '主要会议操作', 'controls.primaryToolbar': '主要会议控制', 'controls.more': '更多', 'controls.audioDevices': '音频与设备', 'controls.screenSettings': '屏幕共享设置', 'controls.webrtcData': 'WebRTC 数据', 'controls.settings': '音频与共享设置', 'controls.settingsShort': '设置', 'controls.navigation': '会议导航', 'controls.closePanel': '关闭面板', 'controls.adaptiveQuality': '自适应屏幕共享 · 30–60 帧', 'controls.connection': ({ state }) => `连接状态：${state}`, 'controls.microphoneStatus': ({ state }) => `麦克风${state}。`,
