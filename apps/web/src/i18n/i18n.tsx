...
const en = {
  ...
  'controls.screenBitrate': '60fps bitrate ceiling',
...
const zhCN: Record<MessageKey, Message> = {
  ...
  'room.eyebrow': '会议室', 'room.heading': ({ name }) => `${name}，你已进入会议`, 'room.sidePanel': '会议侧栏', 'room.devicesFailed': '无法获取音频设备列表。',
