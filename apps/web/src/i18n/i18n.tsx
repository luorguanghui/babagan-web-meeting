...
const en = {
  ...
  'controls.p2pHint': ({ count, bitrate }) => count === 0
    ? 'Choose a total P2P upload budget; active viewers share it equally.'
    : `Suggested total P2P upload budget: ${bitrate} Mbps, shared equally across ${count} online viewer${count === 1 ? '' : 's'}.`,
