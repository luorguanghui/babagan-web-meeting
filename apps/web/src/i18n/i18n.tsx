...
const en = {
  ...
  'controls.adaptiveQuality': 'Adaptive 1080p · 30–60 fps',
  ...
  'controls.standard': 'Standard (1080p30)',
  'controls.motion': 'High motion (1080p60)',
  'controls.screenBitrate': 'Maximum screen-share bitrate',
  'controls.p2pHint': ({ count, bitrate }) => count === 0
    ? 'Direct P2P sharing, up to 5–10 Mbps.'
    : `Direct P2P sharing · suggested ${bitrate} Mbps for ${count} online viewer${count === 1 ? '' : 's'}`,
...
const zhCN: Record<MessageKey, Message> = {
  ...
  'controls.label': '会议控制', 'controls.primaryActions': '主要会议操作', 'controls.settings': '音频与共享设置', 'controls.adaptiveQuality': '自适应 1080p · 30–60 帧', 'controls.connection': ({ state }) => `连接状态：${state}`, 'controls.microphoneStatus': ({ state }) => `麦克风${state}。`,
