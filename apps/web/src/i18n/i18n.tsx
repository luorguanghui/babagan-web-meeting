...
const zhCN: Record<MessageKey, Message> = {
  ...
  'join.nickname': '昵称', 'join.password': '会议密码', 'join.ifRequired': '如会议要求', 'join.submit': '静音加入', 'join.submitting': '正在加入…', 'join.loading': '正在检查会议…', 'join.lookupFailed': '无法加载会议信息，请检查网络后重试。', 'join.retry': '重试',
