...
const zhCN: Record<MessageKey, Message> = {
  ...
  'controls.label': '会议控制', 'controls.primaryActions': '主要会议操作', 'controls.settings': '音频与共享设置', 'controls.settingsShort': '设置', 'controls.navigation': '会议导航', 'controls.closePanel': '关闭面板', 'controls.adaptiveQuality': '自适应屏幕共享 · 30–60 帧', 'controls.connection': ({ state }) => `连接状态：${state}`, 'controls.microphoneStatus': ({ state }) => `麦克风${state}。`,
